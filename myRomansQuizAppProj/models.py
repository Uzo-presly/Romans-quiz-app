...
if __name__ == "__main__":
    ...
    if session.query(Question).count() == 0:
        questions = [
        Question(prompt="Why is the person who judges others without self-reflection inexcusable?",
                 ...
                 correct=2),
        Question(prompt="What leads people to repentance according to Romans 2:4?",
                 option_0="Fear of hell",
                 option_1="God's goodness",
                 option_2="Peer pressure",
                 option_3="The Law of Moses",
                 correct=1),
        Question(prompt="What does stubbornness and an unrepentant heart store up?",
                 option_0="Hope for the future",
                 option_1="Earthly blessings",
                 option_2="God's wrath",
                 option_3="Greater understanding",
                 correct=2),
        Question(prompt="How will God judge each person, as stated in Romans 2:6?",
                 ...
                 correct=1),
        Question(prompt="What reward is promised to those who seek glory, honor, and immortality?",
                 option_0="Peace and prosperity",
                 option_1="Eternal life",
                 option_2="Earthly riches",
                 option_3="Leadership over nations",
                 correct=1),
        Question(prompt="What will happen to those who are self-seeking and disobedient to the truth?",
                 ...
                 correct=2),
        Question(prompt="According to Romans 2:11, what is true about God's judgment?",
                 ...
                 correct=1),
        Question(prompt="Who will be justified before God according to Romans 2:13?", 
                 ...
                 correct=2),
        Question(prompt="What does Paul say about Gentiles who do not have the law?",
                 ...
                 correct=2),
        Question(prompt="Who is the real Jew according to Romans 2:29?", 
